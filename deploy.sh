...
SQL_FILE="${PROJECT_DIR}/mohinhhungthinh.sql"
DB_NAME="mohinhhungthinh"
DB_USER="mohinhhungthinh"
DB_PASSWORD="mohinhhungthinhmohinhhungthinh"  # Thay đổi mật khẩu nếu cần
