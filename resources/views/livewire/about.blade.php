<div>
    ...
    <head>
        ...
        <script type='text/javascript'
            src='/assets/wp-includes/js/jquery/jquery.min.js?ver=3.6.4'
            id='jquery-core-js'></script>
        <script type='text/javascript'
            src='/assets/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.0'
    ...
    <body
        class="post-template-default single single-post postid-115 single-format-standard theme-flatsome woocommerce-no-js lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border">
                ...
                <div id="content" class="blog-wrapper blog-single page-wrapper">
                    ...
                    <div class="row align-center">
                        <div class="large-10 col">
                            ...
                            <article id="post-115"
                                class="post-115 post type-post status-publish format-standard has-post-thumbnail hentry category-nhan-su">
                                <div class="article-inner ">
                                    <header class="entry-header">
                                        <div class="entry-header-text entry-header-text-top text-left">
                                            <h6 class="entry-category is-xsmall">
                                                <a rel="category tag">Giới thiệu</a>
                                            </h6>

                                            <h1 class="entry-title">Giới Thiệu Công Ty Mô hình kiến trúc</h1>
